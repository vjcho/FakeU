...
cur.execute("CREATE TABLE meeting (INSTRUCTOR CHAR(32), TYPE CHAR(25), DAYS CHAR(10), starttime TIME, endtime TIME, BUILD CHAR(10), ROOM INTEGER, MCID INTEGER, TERM CHAR(10))") #, MCID INTEGER REFERENCES course(CID)")
...
cur.execute("CREATE TABLE roster (RCID INTEGER, RINSTRUCTOR CHAR(32), RSID INTEGER, RTERM CHAR(10))")
