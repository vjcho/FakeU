...
cur.execute("CREATE TABLE meeting (INSTRUCTOR CHAR(60), TYPE CHAR(40), DAYS CHAR(10), TIME CHAR(60), BUILD CHAR(60), ROOM CHAR(60), MCID INTEGER)") #, MCID INTEGER REFERENCES course(CID)")
cur.execute("CREATE TABLE student (SEAT INTEGER, SID INTEGER, SURNAME CHAR(60), PREFNAME CHAR(60), LEVEL CHAR(6), UNITS FLOAT, CLASS CHAR(5), MAJOR CHAR(40), GRADE CHAR(20), STATUS CHAR(40), EMAIL CHAR(60), SCID INTEGER)")
cur.execute("CREATE TABLE roster (RCID INTEGER, RINSTRUCTOR CHAR(60), RSID INTEGER, RTERM CHAR(20))")
...
for r in meetingar:
    meeting_str += '('
    meeting_str += cur.mogrify("%s,%s,%s,%s,%s,%s,%s", (r[0],r[1],r[2],r[3],r[4],r[5],r[6]))
    meeting_str += '),'

for r in studar:
    stud_str += '('
    stud_str += cur.mogrify("%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s", (r[0],r[1],r[2],r[3],r[4],r[5],r[6],r[7],r[8],r[9],r[10],r[11]))
    stud_str += '),'
