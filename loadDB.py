...
#create tables
cur.execute("CREATE TABLE course (CID INTEGER, TERM INTEGER, SUBJ CHAR(3), CRSE INTEGER, SEC INTEGER, UNITS CHAR(20), CLASS CHAR(10))")
cur.execute("CREATE TABLE meeting (INSTRUCTOR CHAR(32), TYPE CHAR(25), DAYS CHAR(10), starttime TIME, endtime TIME, BUILD CHAR(10), ROOM INTEGER, MCID INTEGER, TERM INTEGER)") #, MCID INTEGER REFERENCES course(CID)")
cur.execute("CREATE TABLE student (SEAT INTEGER, SID INTEGER, SURNAME CHAR(32), PREFNAME CHAR(32), LEVEL CHAR(6), UNITS FLOAT, CLASS CHAR(5), MAJOR CHAR(8), GRADE CHAR(20), STATUS CHAR(40), EMAIL CHAR(60), SCID INTEGER, STERM INTEGER)")
cur.execute("CREATE TABLE roster (RCID INTEGER, RINSTRUCTOR CHAR(32), RSID INTEGER, RTERM INTEGER)")
