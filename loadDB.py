...
cur.execute("CREATE TABLE meeting (INSTRUCTOR CHAR(32), TYPE CHAR(25), DAYS CHAR(10), starttime TIME, endtime TIME, BUILD CHAR(10), ROOM CHAR(10), MCID INTEGER, TERM INTEGER)") #, MCID INTEGER REFERENCES course(CID)")
